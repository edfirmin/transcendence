...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ["id", "username", "is42stud", "profil_pic", "is2FA", "first_name", "last_name", "email", "win_count", "lose_count", "tourney_win_count", "hangman_score", "hangman_win_count", "hangman_lose_count", "hangman_find_letter", "hangman_miss_letter", "default_map_index", "default_paddle_index", "default_points_index"]
